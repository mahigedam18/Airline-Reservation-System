...
public class Signup extends JFrame implements ActionListener{
    ...
    Signup(){
       ...
       lblsecurity.setBounds(30, 140,110, 25);
       ...
       security1.setBounds(140,140,120,25);
       p1.add(security1);
       ...
       ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("airlineicons/signup1.jpg"));
       Image i2= i1.getImage().getScaledInstance(340,360,Image.SCALE_DEFAULT);
       ImageIcon i3 = new ImageIcon(i2);
       JLabel image = new JLabel(i3);
       image.setBounds(350,0,340,380);
       add(image);
